...
export default function Home() {
  ...
  const iconGroupStyle = { display: 'flex', alignItems: 'center', gap: '25px', justifyContent: 'center' };
  ...
  const icons = {
    ...
    facebook: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="#1877F2"><path d="M12 2.04C6.5 2.04 2.04 6.5 2.04 12c0 4.97 3.64 9.09 8.41 9.84v-6.96h-2.53V12h2.53V9.66c0-2.51 1.49-3.89 3.77-3.89 1.09 0 2.23.19 2.23.19v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.88h-2.34v6.96C18.36 21.09 22 16.97 22 12c0-5.5-4.5-9.96-10-9.96z"></path></svg>
    ),
    instagram: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="#E4405F"><path d="M7.8 2h8.4c3.2 0 5.8 2.6 5.8 5.8v8.4c0 3.2-2.6 5.8-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 017.8 2m-.2 2A3.6 3.6 0 004 7.6v8.8c0 2 1.6 3.6 3.6 3.6h8.8c2 0 3.6-1.6 3.6-3.6V7.6A3.6 3.6 0 0016.4 4H7.6M12 7a5 5 0 015 5 5 5 0 01-5 5 5 5 0 01-5-5 5 5 0 015-5m0 2a3 3 0 00-3 3 3 3 0 003 3 3 3 0 003-3 3 3 0 00-3-3m5.1-.9a1.1 1.1 0 11-1.1 1.1 1.1 1.1 0 011.1-1.1z"></path></svg>
    )
  };
    ...
    <div style={{ backgroundColor: '#f0fdf4', minHeight: '100vh', fontFamily: 'sans-serif', color: '#1e293b' }}>
      ...
      <header style={heroStyle}>
        ...
        <p style={{ fontSize: '20px', opacity: 0.9, maxWidth: '700px', margin: '0 auto' }}>
          Leading Professional Artificial Turf Manufacturer for Global Projects.
        </p>
      </header>
      ...
      <main style={{ maxWidth: '1200px', margin: '60px auto', padding: '0 20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '40px' }}>
        <div style={cardStyle}>
          ...
          <div style={{ padding: '30px' }}><h3>Gym & Fitness Turf</h3><p>High-density fibers for heavy training.</p></div>
        </div>
        <div style={cardStyle}>
          <img src="/images/golf.jpg.png" alt="Golf" style={imgStyle} />
          <div style={{ padding: '30px' }}><h3>Professional Golf Green</h3><p>Superior putting surfaces for realistic roll.</p></div>
        </div>
        <div style={cardStyle}>
          <img src="/images/pet.jpg.png" alt="Pet" style={imgStyle} />
          <div style={{ padding: '30px' }}><h3>Pet Friendly Grass</h3><p>Safe, non-toxic and easy to clean.</p></div>
        </div>
      </main>

      <footer style={{ backgroundColor: '#fff', padding: '60px 20px', textAlign: 'center', borderTop: '1px solid #e2e8f0' }}>
        <h2 style={{ fontSize: '24px', marginBottom: '30px', color: '#166534' }}>Follow Our Social Media</h2>
        ...
        <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" style={{ ...btnStyle, padding: '15px 40px', fontSize: '18px' }}>
          {icons.whatsapp} Contact: +86 188 3109 7125
        </a>
        <p style={{ color: '#64748b', marginTop: '20px' }}>Email: {myEmail}</p>
        <p style={{ fontSize: '14px', color: '#94a3b8', marginTop: '30px' }}>© 2026 {companyName}</p>
      </footer>
    </div>
  );
}
